...
var PanelScrollExample = /** @class */ (function (_super) {
    ...
    PanelScrollExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(Panel, { isOpen: this.state.showPanel, type: PanelType.smallFixedFar, onDismiss: this._hidePanel, isFooterAtBottom: true, headerText: "Panel with scrolling content", closeButtonAriaLabel: "Close", onRenderFooterContent: this._onRenderFooterContent },
