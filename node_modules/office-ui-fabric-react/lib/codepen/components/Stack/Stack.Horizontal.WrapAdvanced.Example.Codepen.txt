let { Dropdown, IDropdownOption, Slider, Stack, mergeStyleSets, DefaultPalette, Fabric } = window.Fabric;
...
class HorizontalStackWrapAdvancedExample extends React.Component<{}, IExampleState> {
  constructor(props: {}) {
    super(props);
    this.state = {
      stackWidth: 100,
...
ReactDOM.render(<HorizontalStackWrapAdvancedExample />, document.getElementById('content'));
