...
import { DocumentCard, DocumentCardActions, DocumentCardActivity, DocumentCardDetails, DocumentCardImage, DocumentCardLocation, DocumentCardPreview, DocumentCardTitle, DocumentCardLogo, DocumentCardStatus } from 'office-ui-fabric-react/lib/DocumentCard';
...
var DocumentCardCompleteExample = /** @class */ (function (_super) {
    ...
    DocumentCardCompleteExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("p", null),
            React.createElement(DocumentCard, { onClickHref: "http://bing.com" },
                React.createElement(DocumentCardImage, { height: 100, imageFit: ImageFit.cover, iconProps: { iconName: 'OneNoteLogo', styles: { root: { color: '#813a7c' } } }, imageSrc: TestImages.documentPreviewTwo }),
                React.createElement(DocumentCardDetails, null,
                    React.createElement(DocumentCardTitle, { title: "How to make good design", shouldTruncate: true })),
                React.createElement(DocumentCardActivity, { activity: "Modified March 13, 2018", people: [
                        { name: 'Annie Lindqvist', profileImageSrc: TestImages.personaFemale },
                        { name: 'Roko Kolar', profileImageSrc: '', initials: 'JH' }
                    ] })),
            React.createElement("p", null),
            React.createElement(DocumentCard, { onClickHref: "http://bing.com" },
                ...
                React.createElement(DocumentCardDetails, null,
                    React.createElement(DocumentCardTitle, { title: "How to make good design without an image", shouldTruncate: true })),
                React.createElement(DocumentCardActivity, { activity: "Modified January 1, 2019", people: [{ name: 'Roko Kolar', profileImageSrc: '', initials: 'JH' }] }))));
    };
