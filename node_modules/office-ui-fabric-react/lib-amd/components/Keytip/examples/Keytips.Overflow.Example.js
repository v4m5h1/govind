    ...
    var KeytipsOverflowExample = /** @class */ (function (_super) {
        ...
        KeytipsOverflowExample.prototype.render = function () {
            return (React.createElement("div", null,
                ...
                React.createElement(OverflowSet_1.OverflowSet, { className: "u-marginBottom", items: this.state.items, overflowItems: this.state.overflowItems, keytipSequences: KeytipSetup_1.keytipMap.OverflowButton4.keySequences, onRenderOverflowButton: this._onRenderOverflowButton, onRenderItem: this._onRenderItem }),
