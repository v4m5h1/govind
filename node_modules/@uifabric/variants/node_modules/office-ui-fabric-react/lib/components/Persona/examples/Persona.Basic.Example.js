...
var PersonaBasicExample = /** @class */ (function (_super) {
    ...
    PersonaBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Label, { className: exampleStyles.exampleLabel }, "Size 8 Persona, with no presence"),
            React.createElement(Persona, tslib_1.__assign({}, examplePersona, { size: PersonaSize.size8, hidePersonaDetails: !renderPersonaDetails })),
            React.createElement(Label, { className: exampleStyles.exampleLabel }, "Size 8 Persona, with presence"),
            React.createElement(Persona, tslib_1.__assign({}, examplePersona, { size: PersonaSize.size8, presence: PersonaPresence.offline, hidePersonaDetails: !renderPersonaDetails })),
            ...
            React.createElement(Label, { className: exampleStyles.exampleLabel }, "Size 56 Persona (default) "),
            React.createElement(Persona, tslib_1.__assign({}, examplePersona, { size: PersonaSize.size56, hidePersonaDetails: !renderPersonaDetails, presence: PersonaPresence.online })),
