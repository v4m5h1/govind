...
var BoxNoClickExample = /** @class */ (function (_super) {
    ...
    function BoxNoClickExample(props) {
        ...
        _this._onFocusTrapZoneToggleChanged = function (ev, isToggled) {
            _this.setState({
                isToggled: isToggled
    ...
    BoxNoClickExample.prototype._internalContents = function () {
        ...
        return (React.createElement("div", { className: "ms-FocusTrapZoneBoxExample" },
            ...
            React.createElement("br", null),
            React.createElement(Toggle_1.Toggle, { componentRef: this._setRef, checked: isToggled, onChange: this._onFocusTrapZoneToggleChanged, label: "Focus Trap Zone", onText: "On", offText: "Off" }),
            (function () {
                if (isToggled) {
