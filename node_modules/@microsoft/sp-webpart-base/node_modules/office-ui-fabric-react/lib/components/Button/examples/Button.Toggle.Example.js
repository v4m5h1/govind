    ...
    ButtonToggleExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", null,
                React.createElement(DefaultButton, { "data-automation-id": "test", allowDisabledFocus: true, disabled: disabled, toggle: true, checked: this.state.muted || checked, text: this.state.muted ? 'Volume Muted' : 'Volume Unmuted', onClick: function () {
                        _this.setState({ muted: !_this.state.muted });
                    } }))));
    };
    return ButtonToggleExample;
}(React.Component));
export { ButtonToggleExample };
