...
var DropdownCustomExample = /** @class */ (function (_super) {
    ...
    DropdownCustomExample.prototype.render = function () {
        return (React.createElement("div", { className: "docs-DropdownExample" },
            React.createElement(Dropdown, { placeholder: "Select an Option", label: "Custom example:", ariaLabel: "Custom dropdown example", onRenderPlaceHolder: this._onRenderPlaceHolder, onRenderTitle: this._onRenderTitle, onRenderOption: this._onRenderOption, onRenderCaretDown: this._onRenderCaretDown, options: [
