define(["require", "exports", "tslib", "react", "../../../Utilities", "../../../utilities/color/colors"], function (require, exports, tslib_1, React, Utilities_1, colors_1) {
    ...
    var ColorRectangleBase = /** @class */ (function (_super) {
        ...
        ColorRectangleBase.prototype.render = function () {
            ...
            return (React.createElement("div", { ref: this._root, className: classNames.root, style: { minWidth: minSize, minHeight: minSize, backgroundColor: colors_1.getFullColorString(color) }, onMouseDown: this._onMouseDown },
    ...
    function _getNewColor(ev, prevColor, root) {
        ...
        return colors_1.updateSV(prevColor, colors_1.clamp(sPercentage * colors_1.MAX_COLOR_SATURATION, colors_1.MAX_COLOR_SATURATION), colors_1.clamp(colors_1.MAX_COLOR_VALUE - vPercentage * colors_1.MAX_COLOR_VALUE, colors_1.MAX_COLOR_VALUE));
    }
