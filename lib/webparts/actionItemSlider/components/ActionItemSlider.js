...
var ActionItemSlider = /** @class */ (function (_super) {
    ...
    function ActionItemSlider(props, state) {
        ...
        _this.renderImages = function () {
            ...
            _this.state.imageMetaData.map(function (image) {
    ...
    ActionItemSlider.prototype.render = function () {
        ...
        if (this.state.imageMetaData.length > 0) {
            carousel = (React.createElement(Carousel, { autoPlay: true, interval: 1000, infiniteLoop: true }, imageSlides));
        }
        else {
            carousel = React.createElement("span", null, "There are no Images");
        }
        return (React.createElement("div", { className: styles.actionItemSlider },
            React.createElement("div", { className: styles.container }, carousel)));
    };
...
var ActionItemSlider = /** @class */ (function (_super) {
    ...
    ActionItemSlider.prototype.render = function () {
        ...
        var images;
        if (this.state.imageMetaData.length > 0) {
            images = (React.createElement(Carousel, { autoPlay: true }, this.state.imageMetaData.map(function (image, index) {
                return (React.createElement("div", null,
                    React.createElement("img", { src: image.imageUrl }),
                    React.createElement("p", { className: "legend" }, image.title)));
            })));
...
export default ActionItemSlider;
>>>>>>> f8defc49260d7e4a85e326b2eb1bcb2fa023f0b2
