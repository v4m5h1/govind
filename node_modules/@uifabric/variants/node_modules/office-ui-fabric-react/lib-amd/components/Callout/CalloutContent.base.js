    ...
    var CalloutContentBase = /** @class */ (function (_super) {
        ...
        CalloutContentBase.prototype._addListeners = function () {
            ...
            this._async.setTimeout(function () {
                _this._disposables.push(Utilities_1.on(_this._targetWindow, 'scroll', _this._dismissOnScroll, true), Utilities_1.on(_this._targetWindow, 'resize', _this._dismissOnResize, true), Utilities_1.on(_this._targetWindow.document.documentElement, 'focus', _this._dismissOnLostFocus, true), // FABRIC7TODO remove any
                Utilities_1.on(_this._targetWindow.document.documentElement, 'click', _this._dismissOnLostFocus, true) // FABRIC7TODO remove any
                );
