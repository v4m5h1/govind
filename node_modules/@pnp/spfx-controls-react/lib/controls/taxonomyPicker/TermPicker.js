   ...
   */
    TermPicker.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(TermBasePicker, { disabled: this.props.disabled, onResolveSuggestions: this.onFilterChanged, onRenderSuggestionsItem: this.onRenderSuggestionsItem, getTextFromItem: this.onGetTextFromItem, onRenderItem: this.onRenderItem, defaultSelectedItems: this.props.value, selectedItems: this.state.terms, onChange: this.props.onChanged, itemLimit: !this.props.allowMultipleSelections ? 1 : undefined, className: TaxonomyPicker_module_scss_1.default.termBasePicker })));
    };
    return TermPicker;
}(React.Component));
