define(["require", "exports", "tslib", "react", "../../Utilities", "../../utilities/selection/interfaces", "./DetailsList", "../../Shimmer", "./DetailsList.types", "./DetailsRow.styles"], function (require, exports, tslib_1, React, Utilities_1, interfaces_1, DetailsList_1, Shimmer_1, DetailsList_types_1, DetailsRow_styles_1) {
    ...
    var ShimmeredDetailsListBase = /** @class */ (function (_super) {
        ...
        ShimmeredDetailsListBase.prototype.render = function () {
            var _a = this.props, enableShimmer = _a.enableShimmer, items = _a.items, listProps = _a.listProps, onRenderCustomPlaceholder = _a.onRenderCustomPlaceholder, removeFadingOverlay = _a.removeFadingOverlay, shimmerLines = _a.shimmerLines, styles = _a.shimmerOverlayStyles, theme = _a.theme, restProps = tslib_1.__rest(_a, ["enableShimmer", "items", "listProps", "onRenderCustomPlaceholder", "removeFadingOverlay", "shimmerLines", "shimmerOverlayStyles", "theme"]);
            ...
            var newListProps = tslib_1.__assign({}, listProps, { 
                ...
                className: enableShimmer && !removeFadingOverlay ? Utilities_1.css(this._classNames.root, listClassName) : undefined });
            return (React.createElement(DetailsList_1.DetailsList, tslib_1.__assign({}, restProps, { items: enableShimmer ? this._shimmerItems : items, onRenderMissingItem: this._onRenderShimmerPlaceholder, listProps: newListProps })));
        };
