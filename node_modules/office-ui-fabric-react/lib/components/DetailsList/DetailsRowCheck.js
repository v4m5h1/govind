...
var DetailsRowCheckBase = function (props) {
    ...
    return canSelect ? (React.createElement("div", tslib_1.__assign({}, buttonProps, { role: "checkbox", className: css(classNames.root, classNames.check, checkClassNames.checkHost), "aria-checked": isPressed, "data-selection-toggle": true, "data-automationid": "DetailsRowCheck" }),
        React.createElement(Check, { checked: isPressed }))) : (React.createElement("div", tslib_1.__assign({}, buttonProps, { className: css(classNames.root, classNames.check) })));
};
