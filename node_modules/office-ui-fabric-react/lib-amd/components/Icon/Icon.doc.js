define(["require", "exports", "react", "./examples/Icon.Basic.Example", "./examples/Icon.Svg.Example", "./examples/Icon.Color.Example", "./examples/Icon.ImageSheet.Example", "./Icon.checklist"], function (require, exports, React, Icon_Basic_Example_1, Icon_Svg_Example_1, Icon_Color_Example_1, Icon_ImageSheet_Example_1, Icon_checklist_1) {
    "use strict";
    ...
    var IconBasicExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/Icon/Icon.Basic.Example.Codepen.txt');
    ...
    exports.IconPageProps = {
        ...
        componentStatus: Icon_checklist_1.IconStatus,
        examples: [
            {
                title: 'Icon',
