define(["require", "exports", "react", "./examples/Layer.Basic.Example", "./examples/Layer.Hosted.Example", "./examples/Layer.Customized.Example", "./examples/Layer.NestedLayers.Example", "./Layer.checklist"], function (require, exports, React, Layer_Basic_Example_1, Layer_Hosted_Example_1, Layer_Customized_Example_1, Layer_NestedLayers_Example_1, Layer_checklist_1) {
    "use strict";
    ...
    exports.LayerPageProps = {
        ...
        componentStatus: Layer_checklist_1.LayerStatus,
        examples: [
            {
