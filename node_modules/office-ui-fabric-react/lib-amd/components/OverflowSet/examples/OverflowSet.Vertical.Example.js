define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Utilities", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/Tooltip", "office-ui-fabric-react/lib/common/DirectionalHint", "office-ui-fabric-react/lib/OverflowSet"], function (require, exports, tslib_1, React, Utilities_1, Button_1, Tooltip_1, DirectionalHint_1, OverflowSet_1) {
    "use strict";
    ...
    var OverflowSetVerticalExample = /** @class */ (function (_super) {
        ...
        OverflowSetVerticalExample.prototype._onRenderItem = function (item) {
            return (React.createElement(Tooltip_1.TooltipHost, { content: item.name, calloutProps: { directionalHint: DirectionalHint_1.DirectionalHint.rightCenter, beakWidth: 12 } },
