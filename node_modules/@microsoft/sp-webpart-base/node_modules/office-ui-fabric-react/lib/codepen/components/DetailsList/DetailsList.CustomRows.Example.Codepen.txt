let { DetailsList, DetailsRow, IDetailsRowProps, IDetailsRowStyles, getTheme, IGroup, Fabric } = window.Fabric;

const theme = getTheme();

class DetailsListCustomRowsExample extends React.Component<{}, {}> {
...
ReactDOM.render(<DetailsListCustomRowsExample />, document.getElementById('content'));
