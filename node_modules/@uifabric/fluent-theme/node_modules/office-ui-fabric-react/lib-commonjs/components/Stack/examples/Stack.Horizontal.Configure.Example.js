    ...
    HorizontalStackConfigureExample.prototype.render = function () {
        ...
        return (React.createElement(Stack_1.Stack, { tokens: sectionStackTokens },
            React.createElement(Stack_1.Stack, { horizontal: true, disableShrink: true },
                ...
                React.createElement(Stack_1.Stack.Item, { grow: true },
                    React.createElement(Stack_1.Stack, { horizontal: true, disableShrink: true, tokens: configureStackTokens },
                        React.createElement(Stack_1.Stack, null,
            ...
            React.createElement(Stack_1.Stack, { horizontal: true, disableShrink: true, verticalAlign: "end", tokens: configureStackTokens },
                React.createElement(Stack_1.Stack.Item, { grow: true },
            ...
            React.createElement(Stack_1.Stack, { horizontal: true, wrap: wrap, disableShrink: disableShrink, horizontalAlign: horizontalAlignment, verticalAlign: verticalAlignment, styles: stackStyles, tokens: exampleStackTokens }, this._range(1, numItems).map(function (value, index) {
