...
export class SPTermStoreService {
   ...
   */
  public async getTermsFromTermSetAsync(
    termSetName: string,
    termSetLocal: Number
  ): Promise<ISPTermObject[]> {
    if (
      ...
      let response: SPHttpClientResponse = await this.spHttpClient.post(
        contextInfoUrl,
      ...
      let clientServiceUrl =
        this.siteAbsoluteUrl + "/_vti_bin/client.svc/ProcessQuery";
      let data =
        ...
        termSetName +
        '</Parameter><Parameter Type="Int32">' +
        termSetLocal +
      ...
      let serviceResponse: SPHttpClientResponse = await this.spHttpClient.post(
        clientServiceUrl,
        SPHttpClient.configurations.v1,
        httpPostOptions
      );
      ...
      let termSetsCollections = serviceJSONResponse.filter(
        (child: any) =>
          child != null &&
          child["_ObjectType_"] !== undefined &&
          child["_ObjectType_"] === "SP.Taxonomy.TermSetCollection"
      );
      ...
      if (termSetsCollections != null && termSetsCollections.length > 0) {
        ...
        let termSets = childTermSets.filter(
          (child: any) =>
            child != null &&
            child["_ObjectType_"] !== undefined &&
            child["_ObjectType_"] === "SP.Taxonomy.TermSet"
        );
        ...
        if (termSets != null && termSets.length > 0) {
          ...
          return await Promise.all<ISPTermObject>(
            childItems.map(
              async (t: any): Promise<ISPTermObject> => {
  ...
  private async getChildTermsAsync(term: any): Promise<ISPTermObject[]> {
    ...
    if (Number(term["TermsCount"]) > 0) {
      ...
      let clientServiceUrl =
        this.siteAbsoluteUrl + "/_vti_bin/client.svc/ProcessQuery";
      let data =
        '<Request AddExpandoFieldTypeSuffix="true" SchemaVersion="15.0.0.0" LibraryVersion="16.0.0.0" ApplicationName=".NET Library" xmlns="http://schemas.microsoft.com/sharepoint/clientquery/2009"><Actions><ObjectPath Id="20" ObjectPathId="19" /><Query Id="21" ObjectPathId="19"><Query SelectAllProperties="false"><Properties /></Query><ChildItemQuery SelectAllProperties="true"><Properties><Property Name="CustomSortOrder" ScalarProperty="true" /><Property Name="LocalCustomProperties" ScalarProperty="true" /></Properties></ChildItemQuery></Query></Actions><ObjectPaths><Property Id="19" ParentId="16" Name="Terms" /><Identity Id="16" Name="' +
        term["_ObjectIdentity_"] +
        '" /></ObjectPaths></Request>';
      let httpPostOptions: ISPHttpClientOptions = {
        headers: {
          accept: "application/json",
      ...
      let termsCollections = serviceJSONResponse.filter(
        (child: any) =>
          child != null &&
          child["_ObjectType_"] !== undefined &&
          child["_ObjectType_"] === "SP.Taxonomy.TermCollection"
      );
  ...
  private async projectTermAsync(term: any): Promise<ISPTermObject> {
    return {
      identity:
        term["_ObjectIdentity_"] !== undefined ? term["_ObjectIdentity_"] : "",
      isAvailableForTagging:
        term["IsAvailableForTagging"] !== undefined
          ? term["IsAvailableForTagging"]
          : false,
      guid: term["Id"] !== undefined ? this.cleanGuid(term["Id"]) : "",
      name: term["Name"] !== undefined ? term["Name"] : "",
      customSortOrder:
        term["CustomSortOrder"] !== undefined ? term["CustomSortOrder"] : "",
      terms: await this.getChildTermsAsync(term),
      localCustomProperties:
        term["LocalCustomProperties"] !== undefined
