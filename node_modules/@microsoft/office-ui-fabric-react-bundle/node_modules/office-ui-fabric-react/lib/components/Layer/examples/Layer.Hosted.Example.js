...
var LayerHostedExample = /** @class */ (function (_super) {
    ...
    LayerHostedExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            showHost && React.createElement(LayerHost, { id: this._layerHostId, className: "LayerExample-customHost" }),
            ...
            React.createElement(Checkbox, { className: exampleStyles.exampleCheckbox, label: "Render the box below in a Layer and target it at hostId=" + this._layerHostId, checked: showLayer, onChange: this._onChangeCheckbox }),
            showLayer ? (React.createElement(Layer, { hostId: this._layerHostId, onLayerDidMount: this._log('didmount'), onLayerWillUnmount: this._log('willunmount'), className: "exampleLayerClassName" }, content)) : (content),
