...
var DetailsListNavigatingFocusExample = /** @class */ (function (_super) {
    ...
    DetailsListNavigatingFocusExample.prototype.render = function () {
        ...
        return (React.createElement(DetailsList, { key: this.state.key, items: this.state.items, columns: this._columns, onItemInvoked: this._navigate, initialFocusedIndex: this.state.initialFocusedIndex, ariaLabelForSelectionColumn: "Toggle selection", ariaLabelForSelectAllCheckbox: "Toggle selection for all items" }));
    };
