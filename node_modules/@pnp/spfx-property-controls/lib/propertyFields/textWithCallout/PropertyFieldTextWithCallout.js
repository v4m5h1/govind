...
var PropertyFieldTextWithCalloutBuilder = (function () {
    ...
    PropertyFieldTextWithCalloutBuilder.prototype._render = function (elem, context, changeCallback) {
        ...
        var element = React.createElement(PropertyFieldTextWithCalloutHost_1.default, __assign({}, props, { onChanged: this._onChanged.bind(this) }));
    ...
    PropertyFieldTextWithCalloutBuilder.prototype._onChanged = function (checked) {
