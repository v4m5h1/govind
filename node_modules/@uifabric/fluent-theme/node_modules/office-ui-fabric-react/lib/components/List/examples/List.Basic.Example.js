...
var ListBasicExample = /** @class */ (function (_super) {
    ...
    ListBasicExample.prototype._onRenderCell = function (item, index) {
        return (React.createElement("div", { className: styles.itemCell, "data-is-focusable": true },
            React.createElement(Image, { className: styles.itemImage, src: item.thumbnail, width: 50, height: 50, imageFit: ImageFit.cover }),
            ...
            React.createElement(Icon, { className: styles.chevron, iconName: getRTL() ? 'ChevronLeft' : 'ChevronRight' })));
    };
