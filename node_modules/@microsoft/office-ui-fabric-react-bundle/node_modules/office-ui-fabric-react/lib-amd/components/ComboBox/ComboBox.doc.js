define(["require", "exports", "react", "./examples/ComboBox.Basic.Example", "./examples/ComboBox.Toggles.Example", "./examples/ComboBox.Controlled.Example", "./examples/ComboBox.Virtualized.Example", "./examples/ComboBox.CustomStyled.Example", "./ComboBox.checklist"], function (require, exports, React, ComboBox_Basic_Example_1, ComboBox_Toggles_Example_1, ComboBox_Controlled_Example_1, ComboBox_Virtualized_Example_1, ComboBox_CustomStyled_Example_1, ComboBox_checklist_1) {
    "use strict";
    ...
    var ComboBoxTogglesExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/ComboBox/ComboBox.Toggles.Example.Codepen.txt');
    ...
    var ComboBoxControlledExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/ComboBox/ComboBox.Controlled.Example.Codepen.txt');
    ...
    var ComboBoxVirtualizedExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/ComboBox/ComboBox.Virtualized.Example.Codepen.txt');
    ...
    var ComboBoxCustomStyledExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/ComboBox/ComboBox.CustomStyled.Example.Codepen.txt');
