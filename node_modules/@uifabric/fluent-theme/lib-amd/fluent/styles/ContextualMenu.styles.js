                ...
                menuItem: function (itemStyleProps) {
                    ...
                    return {
                        root: [
                            ...
                            !disabled &&
                                ...
                                selectors: (_a = {
                                    ...
                                    _a["." + Utilities_1.IsFocusVisibleClassName + " &:focus, ." + Utilities_1.IsFocusVisibleClassName + " &:focus:hover"] = { backgroundColor: palette.white },
                                    _a)
                            },
                            disabled && {
                        ...
                        splitContainer: {
                            height: CONTEXTUAL_MENU_ITEM_HEIGHT,
                            selectors: (_b = {},
                                _b["." + Utilities_1.IsFocusVisibleClassName + " &:focus, ." + Utilities_1.IsFocusVisibleClassName + " &:focus:hover"] = { backgroundColor: palette.white },
                                _b)
                        },
                        subMenuIcon: [
                            {
