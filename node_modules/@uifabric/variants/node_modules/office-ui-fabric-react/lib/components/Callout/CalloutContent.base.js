...
var CalloutContentBase = /** @class */ (function (_super) {
    ...
    CalloutContentBase.prototype._addListeners = function () {
        ...
        this._async.setTimeout(function () {
            _this._disposables.push(on(_this._targetWindow, 'scroll', _this._dismissOnScroll, true), on(_this._targetWindow, 'resize', _this._dismissOnResize, true), on(_this._targetWindow.document.documentElement, 'focus', _this._dismissOnLostFocus, true), // FABRIC7TODO remove any
            on(_this._targetWindow.document.documentElement, 'click', _this._dismissOnLostFocus, true) // FABRIC7TODO remove any
            );
