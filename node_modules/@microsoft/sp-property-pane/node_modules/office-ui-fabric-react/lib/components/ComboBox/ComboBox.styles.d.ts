...
export declare const getOptionStyles: (theme: ITheme, customStylesForAllOptions?: Partial<IComboBoxOptionStyles> | undefined, customOptionStylesForCurrentOption?: Partial<IComboBoxOptionStyles> | undefined, isPending?: boolean | undefined) => Partial<IComboBoxOptionStyles>;
