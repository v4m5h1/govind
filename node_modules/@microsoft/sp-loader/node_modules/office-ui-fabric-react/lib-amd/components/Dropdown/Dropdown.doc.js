define(["require", "exports", "react", "./examples/Dropdown.Basic.Example", "./examples/Dropdown.Custom.Example", "./examples/Dropdown.Error.Example", "./examples/Dropdown.Required.Example", "./Dropdown.checklist"], function (require, exports, React, Dropdown_Basic_Example_1, Dropdown_Custom_Example_1, Dropdown_Error_Example_1, Dropdown_Required_Example_1, Dropdown_checklist_1) {
    "use strict";
    ...
    exports.DropdownPageProps = {
        ...
        examples: [
            ...
            },
            {
                ...
                view: React.createElement(Dropdown_Required_Example_1.DropdownRequiredExample, null)
            }
        ],
