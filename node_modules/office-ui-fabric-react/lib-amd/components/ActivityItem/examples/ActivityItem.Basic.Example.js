define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Utilities", "../ActivityItem", "./ActivityItem.Example.styles", "../../../Icon", "../../../Link"], function (require, exports, tslib_1, React, Utilities_1, ActivityItem_1, ActivityItem_Example_styles_1, Icon_1, Link_1) {
    "use strict";
            ...
            var activityItemExamples = [
                {
                    key: 1,
                    activityDescription: [
                        React.createElement(Link_1.Link, { key: 1, className: Utilities_1.css(classNames.nameText), onClick: function () {
                    ...
                    comments: [
                        ...
                        React.createElement(Link_1.Link, { key: 2, className: Utilities_1.css(classNames.nameText), onClick: function () {
                ...
                },
                {
                    ...
                    activityDescription: [
                        ...
                        React.createElement(Link_1.Link, { key: 3, className: Utilities_1.css(classNames.nameText), onClick: function () {
                                alert('A document was clicked.');
                            } }, "PresentationTitle.pptx"),
                        React.createElement("span", { key: 4 }, " to "),
                        React.createElement(Link_1.Link, { key: 5, className: Utilities_1.css(classNames.nameText), onClick: function () {
