define(["require", "exports", "tslib", "react", "../../../Utilities", "./SuggestionsCore", "./SuggestionsControl.scss"], function (require, exports, tslib_1, React, Utilities_1, SuggestionsCore_1, stylesImport) {
    ...
    var SuggestionsHeaderFooterItem = /** @class */ (function (_super) {
        ...
        SuggestionsHeaderFooterItem.prototype.render = function () {
            var _a = this.props, renderItem = _a.renderItem, onExecute = _a.onExecute, isSelected = _a.isSelected, id = _a.id, className = _a.className;
            return onExecute ? (React.createElement("div", { id: id, onClick: onExecute, className: Utilities_1.css('ms-Suggestions-sectionButton', className, styles.actionButton, (_b = {},
                    _b['is-selected ' + styles.buttonSelected] = isSelected,
                    _b)) }, renderItem())) : (React.createElement("div", { id: id, className: Utilities_1.css('ms-Suggestions-section', className, styles.suggestionsTitle) }, renderItem()));
            var _b;
        };
