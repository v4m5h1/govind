define(["require", "exports", "tslib", "office-ui-fabric-react/lib/Checkbox", "office-ui-fabric-react/lib/common/_exampleStyles.scss", "office-ui-fabric-react/lib/Layer", "office-ui-fabric-react/lib/Styling", "office-ui-fabric-react/lib/Toggle", "office-ui-fabric-react/lib/Utilities", "react", "./Layer.Example.scss"], function (require, exports, tslib_1, Checkbox_1, exampleStylesImport, Layer_1, Styling_1, Toggle_1, Utilities_1, React) {
    "use strict";
    ...
    var LayerHostedExample = /** @class */ (function (_super) {
        ...
        LayerHostedExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                ...
                showHost && React.createElement(Layer_1.LayerHost, { id: this._layerHostId, className: "LayerExample-customHost" }),
                ...
                React.createElement(Checkbox_1.Checkbox, { className: exampleStyles.exampleCheckbox, label: "Render the box below in a Layer and target it at hostId=" + this._layerHostId, checked: showLayer, onChange: this._onChangeCheckbox }),
                showLayer ? (React.createElement(Layer_1.Layer, { hostId: this._layerHostId, onLayerDidMount: this._log('didmount'), onLayerWillUnmount: this._log('willunmount'), className: "exampleLayerClassName" }, content)) : (content),
