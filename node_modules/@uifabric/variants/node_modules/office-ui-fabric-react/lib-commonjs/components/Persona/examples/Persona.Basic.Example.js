...
var PersonaBasicExample = /** @class */ (function (_super) {
    ...
    PersonaBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Label_1.Label, { className: exampleStyles.exampleLabel }, "Size 8 Persona, with no presence"),
            React.createElement(Persona_1.Persona, tslib_1.__assign({}, examplePersona, { size: Persona_1.PersonaSize.size8, hidePersonaDetails: !renderPersonaDetails })),
            React.createElement(Label_1.Label, { className: exampleStyles.exampleLabel }, "Size 8 Persona, with presence"),
            React.createElement(Persona_1.Persona, tslib_1.__assign({}, examplePersona, { size: Persona_1.PersonaSize.size8, presence: Persona_1.PersonaPresence.offline, hidePersonaDetails: !renderPersonaDetails })),
            ...
            React.createElement(Label_1.Label, { className: exampleStyles.exampleLabel }, "Size 56 Persona (default) "),
            React.createElement(Persona_1.Persona, tslib_1.__assign({}, examplePersona, { size: Persona_1.PersonaSize.size56, hidePersonaDetails: !renderPersonaDetails, presence: Persona_1.PersonaPresence.online })),
