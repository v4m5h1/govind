...
var DetailsListCustomFooterExample = /** @class */ (function (_super) {
    ...
    DetailsListCustomFooterExample.prototype.render = function () {
        return (React.createElement(DetailsList, { items: this._items, columns: this._columns, setKey: "set", layoutMode: DetailsListLayoutMode.fixedColumns, selectionPreservedOnEmptyClick: true, ariaLabelForSelectionColumn: "Toggle selection", ariaLabelForSelectAllCheckbox: "Toggle selection for all items", onRenderDetailsFooter: this._onRenderDetailsFooter }));
    };
