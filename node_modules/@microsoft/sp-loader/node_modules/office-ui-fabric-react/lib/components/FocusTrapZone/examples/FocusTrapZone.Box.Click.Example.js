...
var BoxNoClickExample = /** @class */ (function (_super) {
    ...
    BoxNoClickExample.prototype._internalContents = function () {
        ...
        return (React.createElement("div", { className: "ms-FocusTrapZoneBoxExample" },
            ...
            React.createElement("br", null),
            React.createElement(Toggle, { componentRef: this._setRef, checked: isToggled, onChange: this._onFocusTrapZoneToggleChanged, label: "Focus Trap Zone", onText: "On", offText: "Off" }),
            (function () {
                if (isToggled) {
