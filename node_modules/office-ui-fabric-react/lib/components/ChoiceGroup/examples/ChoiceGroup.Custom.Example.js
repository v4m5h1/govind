            ...
            React.createElement(ChoiceGroup, { defaultSelectedKey: "B", options: [
                    {
                        ...
                        onRenderField: function (props, render) {
                            return (React.createElement("div", { className: css(styles.root) },
                                render(props),
                                React.createElement(Dropdown, { className: css(styles.dropdown), defaultSelectedKey: "A", options: [{ key: 'A', text: '5 seconds' }, { key: 'B', text: '10 seconds' }, { key: 'C', text: '20 seconds' }], disabled: props ? !props.checked : false, ariaLabel: "Select a time span" })));
                        }
                    },
                    {
                        key: 'B',
