    ...
    RatingBase.prototype.render = function () {
        ...
        for (var i = this._min; i <= max; i++) {
            if (i !== 0) {
                ...
                stars.push(React.createElement("button", tslib_1.__assign({ className: Utilities_1.css(this._classNames.ratingButton, (_c = {},
                        _c[this._classNames.ratingStarIsLarge] = size === Rating_types_1.RatingSize.Large,
                        _c[this._classNames.ratingStarIsSmall] = size !== Rating_types_1.RatingSize.Large,
        ...
        return (React.createElement("div", { className: Utilities_1.css('ms-Rating-star', this._classNames.root, (_d = {},
            ...
            React.createElement(FocusZone_1.FocusZone, { direction: FocusZone_1.FocusZoneDirection.horizontal, tabIndex: readOnly ? 0 : -1, className: Utilities_1.css(this._classNames.ratingFocusZone, (_e = {},
