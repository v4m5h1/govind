...
var TextFieldIconExample = /** @class */ (function (_super) {
    ...
    TextFieldIconExample.prototype.render = function () {
        return (React.createElement("div", { className: "docs-TextFieldExample" },
            React.createElement(TextField, { label: "TextField with an icon", iconProps: { iconName: 'Calendar' } }),
            React.createElement(TextField, { label: "Disabled TextField with an icon", iconProps: { iconName: 'Calendar' }, disabled: true })));
    };
