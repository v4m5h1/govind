...
var RatingBase = /** @class */ (function (_super) {
    ...
    RatingBase.prototype.render = function () {
        ...
        return (React.createElement("div", tslib_1.__assign({ className: css('ms-Rating-star', this._classNames.root, (_b = {},
                ...
                _b)), "aria-label": getAriaLabel ? getAriaLabel(rating ? rating : 0, this.props.max) : '', id: id }, divProps),
            React.createElement(FocusZone, { direction: FocusZoneDirection.horizontal, tabIndex: readOnly ? 0 : -1, className: css(this._classNames.ratingFocusZone, (_c = {},
                    ...
                    _c)), "data-is-focusable": readOnly ? true : false, defaultActiveElement: rating ? starIds[rating - 1] && '#' + starIds[rating - 1] : undefined }, stars)));
    };
