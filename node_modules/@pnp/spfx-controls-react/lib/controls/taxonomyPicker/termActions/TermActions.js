...
var TermLabelAction = (function () {
    function TermLabelAction(title, iconName) {
        ...
        this.applyToTerm = function (currentTerm) {
            var termIndex = sp_lodash_subset_1.findIndex(_this._processedTerms, function (term) { return term.Id == currentTerm.Id; });
            if (termIndex >= 0) {
                return false;
            }
            return true;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (this._labels) {
                            ...
                            updateAction = {
                                updateActionType: _1.UpdateType.updateTermLabel,
                                value: termLabel
                            };
...
exports.TermLabelAction = TermLabelAction;
