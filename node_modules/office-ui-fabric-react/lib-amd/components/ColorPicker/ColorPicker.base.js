    ...
    var ColorPickerBase = /** @class */ (function (_super) {
        ...
        function ColorPickerBase(props) {
            ...
            _this._onAChanged = function (ev, a) {
                _this._updateColor(ev, updateA_1.updateA(_this.state.color, a));
            };
            ...
            for (var _i = 0, colorComponents_1 = colorComponents; _i < colorComponents_1.length; _i++) {
                ...
                _this._textBlurHandlers[component] = _this._onTextBlur.bind(_this, component);
            }
            _this._textLabels = {
                r: props.redLabel,
                g: props.greenLabel,
                        ...
                        React.createElement("tbody", null,
                            React.createElement("tr", null, colorComponents.map(function (comp) {
                                ...
                                return (React.createElement("td", { key: comp, style: comp === 'hex' ? undefined : { width: '18%' } },
                                    React.createElement(TextField_1.TextField, { className: classNames.input, onChange: _this._textChangeHandlers[comp], onBlur: _this._textBlurHandlers[comp], value: _this._getDisplayValue(comp), spellCheck: false, ariaLabel: _this._textLabels[comp] })));
                            })))))));
        };
        ...
        ColorPickerBase.prototype._onTextChange = function (component, event, newValue) {
            ...
            if (isHex) {
                if (newValue && newValue.length === 6) {
                    newColor = getColorFromString_1.getColorFromString('#' + newValue);
                }
            }
            else {
                newColor = getColorFromRGBA_1.getColorFromRGBA((_a = {
                        r: color.r,
                        g: color.g,
                        b: color.b,
                        a: color.a || 100
        ...
        ColorPickerBase.prototype._onTextBlur = function (component, event) {
            var color = this.state.color;
            var isHex = component === 'hex';
            ...
            if (isHex) {
                this._updateColor(event, getColorFromString_1.getColorFromString('#' + newValue));
            }
        };
        /**
