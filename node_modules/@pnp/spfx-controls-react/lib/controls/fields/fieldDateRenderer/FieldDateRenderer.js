 ...
 *   - Date Time
 */
var FieldDateRenderer = (function (_super) {
    ...
    FieldDateRenderer.prototype.render = function () {
        return (React.createElement(FieldBaseTextRenderer_1.FieldBaseTextRenderer, { cssProps: this.props.cssProps, className: Utilities_1.css(this.props.className), noTextRender: true }, this.props.text));
    };
    __decorate([
        decorators_1.override
    ], FieldDateRenderer.prototype, "render", null);
    return FieldDateRenderer;
}(React.Component));
exports.FieldDateRenderer = FieldDateRenderer;
