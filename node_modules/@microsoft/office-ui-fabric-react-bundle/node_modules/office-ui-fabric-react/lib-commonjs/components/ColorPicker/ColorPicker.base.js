...
var ColorPickerBase = /** @class */ (function (_super) {
    ...
    function ColorPickerBase(props) {
        ...
        _this._onHChanged = function (ev, h) {
            _this._updateColor(ev, colors_1.updateH(_this.state.color, h));
        };
        _this._onAChanged = function (ev, a) {
            _this._updateColor(ev, colors_1.updateA(_this.state.color, a));
        };
        _this._warnDeprecations({
            onColorChanged: 'onChange'
        });
        _this.state = {
            color: _getColorFromProps(props) || colors_1.getColorFromString('#ffffff')
        };
                    ...
                    React.createElement("tbody", null,
                        React.createElement("tr", null, colorComponents.map(function (comp) {
                            ...
                            return (React.createElement("td", { key: comp, style: comp === 'hex' ? undefined : { width: '18%' } },
                                React.createElement(TextField_1.TextField, { className: classNames.input, onChange: _this._textChangeHandlers[comp], value: _this._getDisplayValue(comp), spellCheck: false, ariaLabel: _this._textLabels[comp] })));
                        })))))));
    };
    ...
    ColorPickerBase.prototype._onTextChange = function (component, event, newValue) {
        ...
        var newColor;
        if (isHex) {
            newColor = colors_1.getColorFromString('#' + newValue);
        }
        else {
            newColor = colors_1.getColorFromRGBA((_a = {
                    r: color.r,
                    g: color.g,
                    b: color.b,
                    a: color.a || 100
...
function _getColorFromProps(props) {
    ...
    return typeof color === 'string' ? colors_1.getColorFromString(color) : color;
}
