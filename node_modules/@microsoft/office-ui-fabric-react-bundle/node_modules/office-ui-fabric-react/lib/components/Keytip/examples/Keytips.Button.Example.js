...
var KeytipsButtonExample = /** @class */ (function (_super) {
    ...
    KeytipsButtonExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(DefaultButton, { className: "u-marginRight", keytipProps: keytipMap.Button, text: "Button", onClick: function () {
                    console.log('Button');
                } }),
            React.createElement(CompoundButton, { className: "u-marginRight u-marginBottom", keytipProps: keytipMap.CompoundButton, text: "Compound Button", secondaryText: 'With a Keytip', onClick: function () {
                    console.log('Compound Button');
                } }),
            React.createElement(DefaultButton, { className: "u-marginRight", keytipProps: keytipMap.ButtonWithMenu, text: "Button with Menu", onClick: function () {
            ...
            React.createElement(DefaultButton, { className: "u-marginRight", keytipProps: keytipMap.SplitButton, text: "Split Button", split: true, onClick: function () {
            ...
            React.createElement(DefaultButton, { className: "u-marginBottom", keytipProps: keytipMap.ButtonOffset, text: "Button keytip offset 10x10", onClick: function () {
                    console.log('Button');
                } }),
